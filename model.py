...
class VideoGAN(object):
    ...
    def g_background(self, z):
        ...
        self.z_, self.h0_w, self.h0_b = linear(z, 512*4*4, 'g_b_h0_lin', with_w=True)
    ...
    def g_foreground(self, z):
        ...
        self.z_, self.h0_w, self.h0_b = linear(z, 512*4*4*2, 'g_f_h0_lin', with_w=True)
    ...
    def train(self):
        ...
        for epoch in xrange(10):
            ...
            for idx in xrange(0, batch_idxs):
                ...
                errD_real = self.d_loss_real.eval({self.videos: batch_videos}, session=self.sess)
